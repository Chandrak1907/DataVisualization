...
var nation = crossfilter(),
  all = nation.groupAll(),
  per_cap = nation.dimension(function(d) { return d.Total; }),
...
queue()
    ...
    .defer(d3.csv, "State17MayVer2.csv", function(d) {
        
      for(var propertyName in d) {
        // console.log(propertyName);
        
        if (propertyName != "State" && propertyName != 'name' &&  propertyName !='name_y') {
...
function ready(error, us) {
  ...
  svg.append("g")
    ...
    .enter().append("path")
      .attr("class", function(d) { 
        // console.log("id ", d.id, " -- ", quantize(rateById.get(d.id)));
 ...
 function update(d){
  ...
  function cr(data) {
    ...
    // console.log(arr.slice[16,27]);
    // }
    // arr = data.slice(1,12);
    bottombar(arr.slice(15,29));
...
function bottombar(arr){
  data =arr.slice(0,arr.length-2);
  console.log("State nullame ",arr);
  // console.log("410 data");
  // data.pop();
  console.log(" 411 Data ",data);
  for (i =0; i<data.length; i++)
  {
  ...
  console.log(" i am in bottom bar",arr);
